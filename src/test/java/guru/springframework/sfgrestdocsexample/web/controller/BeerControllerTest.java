...
class BeerControllerTest {
    ...
    //Adding Request params to be documented.
    //our controller api does not have request params but we can still set it as an example in the test and the controller is just going to ignore it.
    ...
    void getBeerById() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/beer/{beerId}", UUID.randomUUID().toString())
                .param("iscold", "yes") //this is the request param we emulate
